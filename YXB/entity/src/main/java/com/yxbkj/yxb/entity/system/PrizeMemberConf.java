 ...
 * @since 2018-10-29
 */
@TableName("yxb_prize_member_conf")
public class PrizeMemberConf extends Model<PrizeMemberConf> {
	 ...
	 * @return wrapper对象
	 */
	public Wrapper<PrizeMemberConf> generateSearchWrapper() {
		Wrapper<PrizeMemberConf> wrapper = new EntityWrapper<>();
	...
	public Integer getMinSelfNum() {
		return minSelfNum;
	}

	public void setMinSelfNum(Integer minSelfNum) {
		this.minSelfNum = minSelfNum;
	}
