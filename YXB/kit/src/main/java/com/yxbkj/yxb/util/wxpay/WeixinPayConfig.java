...
public class WeixinPayConfig {
	// 公众号appid
	public final static String APPID = "wxfa5e7a563ca2d87c"; //
	// 公众号appsecret
	public final static String APPSECRET = "cf8ba16ba924a8d93d2cc0f2173b33ad";
	// 证书
	...
	// 公众平台商户ID
	public final static String MCHID = "1502915591"; //
	// 公众平台商户KEY
