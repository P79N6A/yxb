...
public class YeepayService {
	...
	//获取密钥P12
	public static PrivateKey getSecretKey() throws Exception {
		PrivateKey isvPrivateKey = RSAUtils.getPrivateKey(YeePayUtils.isv_private_key);
	...
	public static Map<String, String> requestYOP(YopRequest request,Map<String, String> params, String uri, String[] paramSign) throws IOException{
		Map<String, String> result = new HashMap<String, String>();
		String BASE_URL = getUrl("baseURL");
		String parentMerchantNo = YeepayService.getParentMerchantNo();
		String merchantNo = YeepayService.getMerchantNo();
