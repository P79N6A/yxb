...
import com.alibaba.fastjson.JSONObject;import com.yxbkj.yxb.util.MD5Util;
...
public class ShoujiHuaFei {
    ...
    public static final String key ="374b4fa7c7ec3b635b02259acdac1342";//申请的接口Appkey
    public static final String openId="JHa6868daaf6040b3aa8b5c5b2e8f5c8e1";//在个人中心查询
    public static final String telCheckUrl = "http://test-v.juhe.cn/ofpay/mobile/telcheck?cardnum=*&phoneno=!&key="+key;
    public static final String telQueryUrl="http://test-v.juhe.cn/ofpay/mobile/telquery?cardnum=*&phoneno=!&key="+key;
    public static final String onlineUrl="http://test-v.juhe.cn/ofpay/mobile/onlineorder?key="+key+"&phoneno=!&cardnum=*&orderid=@&sign=$";
    public static final String yueUrl="http://test-v.juhe.cn/ofpay/mobile/yue?key="+key+"&"+"timestamp=%&sign=$";
    public static final String orderstaUrl="http://test-v.juhe.cn/ofpay/mobile/ordersta?key="+key+"&orderid=!";
//---------------------------------------------------------------------------------------------------------------------------------------------
    /**
     * 1.检测手机号码是否能充值接口
     * @param phone 手机号码
    ...
    public static int telCheck(String phone, int cardnum) throws Exception{
        ...
        error_code = JSONObject.parseObject(result).getInteger("error_code");
        return error_code;
    }
    /**
     * 2.根据手机号和面值查询商品信息
